        ...
        >
          ...
          <div className="p-10 sm:p-14 flex flex-col items-center w-full">
            ...
            <div className="text-center mb-12">
              <h1 className="text-white text-4xl sm:text-5xl font-black tracking-tighter leading-tight mb-2">
                Hi there!
              </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6 w-full max-w-2xl">
              {[
                { name: 'React 19', color: 'text-[#61DAFB]', icon: <svg viewBox="-11.5 -10.23174 23 20.46348" className="w-9 h-9 animate-[spin_10s_linear_infinite]"><circle cx="0" cy="0" r="2.05" fill="currentColor"/><g stroke="currentColor" strokeWidth="1" fill="none"><ellipse rx="11" ry="4.2"/><ellipse rx="11" ry="4.2" transform="rotate(60)"/><ellipse rx="11" ry="4.2" transform="rotate(120)"/></g></svg> },
                { name: 'PIXI.js 8', color: 'text-[#E53935]', icon: <svg viewBox="0 0 24 24" className="w-9 h-9"><path fill="currentColor" d="M12 2L2 12l10 10l10-10L12 2zm0 4l6 6l-6 6l-6-6l6-6z"/></svg> },
                ...
                <div 
                  key={idx}
                  className="flex flex-col items-center justify-center gap-4 p-8 rounded-[2rem] bg-white/[0.03] border border-white/5 hover:bg-white/[0.05] transition-all cursor-default group aspect-square min-h-[140px]"
                >
                  <div className={`${tech.color} opacity-90 group-hover:opacity-100 transition-opacity`}>
                    {tech.icon}
                  </div>
                  <span className="text-sm font-black uppercase tracking-widest text-white transition-colors">{tech.name}</span>
                </div>
              ))}
            </div>
