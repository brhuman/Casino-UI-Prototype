...
export const Header = () => {
  ...
  return (
    <header className="h-16 w-full flex items-center justify-between px-4 lg:px-8 bg-gray-900/80 backdrop-blur-md border-b border-gray-800 z-50">
      ...
      <div className="hidden lg:flex bg-black/50 rounded-full px-4 py-1.5 border border-gray-700 shadow-[inset_0_2px_4px_rgba(0,0,0,0.6)] items-center">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="text-sm font-medium hidden lg:block">Player</span>
        </button>
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-72 bg-[#020205] border-l border-white/10 z-[70] p-6 lg:hidden flex flex-col shadow-[-10px_0_40px_rgba(0,0,0,1)]"
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xl font-black italic tracking-tighter text-white uppercase">Neon Spin</span>
                </div>
              ...
              <div className="mb-6 p-4 rounded-2xl bg-white/5 border border-white/5">
                ...
                <p className="font-mono text-2xl font-black text-white decoration-neon-cyan underline-offset-4 decoration-2 underline">
